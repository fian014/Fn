...
var nomor_dana = `081331954019\nA.N A*****AN` //gk usah di ubah ya klo gk punya ntr eror
var nomor_gopay = `081331954019\nA.N A*****AN` //gk usah di ubah ya klo gk punya ntr eror
...
typemenu = 'document'
img = setting.img
apiku = 'https://fian014.github.io/'
gc_wa_lu = 'https://chat.whatsapp.com/LWcGUBM8g387zoOXSZLtsI' //klo gk punya gc wa gk usah di ganti 👍
		...
		if (!mek.key.fromMe && !isGroupAdmins && !isOwner && !isCreator) return reply(lang.onlyOwner())
		     if (!isGroup) return fakegroup(lang.onlygc())
				...
				case 'donasi': case 'donate':
							...
							sendButLocation(from, donasibot() , `Jangan klik doang, donasi ya 🌝 ${enter}${enter}${botname}™© | By ${ownername}`,donas, {})
							break
